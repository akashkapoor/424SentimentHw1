...
def main(argv):
  ...
  try:
   opts, args = getopt.getopt(argv,"p:o:v:t:w:",["path=","ofile=","vocabfile="])
  except getopt.GetoptError:
    print 'Usage: \n python preprocessSentences.py -p <path> -o <outputfile> -v <vocabulary> -t <isTest>'
    sys.exit(2)
  for opt, arg in opts:
    if opt == '-h':
      print 'Usage: \n python preprocessSentences.py -p <path> -o <outputfile> -v <vocabulary> -t <isTest>'
      ...
      vocabf = arg
    elif opt in ("-t", "--istest"):
      isTest = bool(arg)
    elif opt in ("-w", "--wordcountthreshold"):
